                ...
                <div className="flex flex-col justify-center items-center space-y-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-x-8 gap-6 w-full">
                        ...
                        <div className="shadow-md duration-500 hover:scale-105 hover:shadow-xl relative group opacity-90 flex justify-center items-center h-full w-full">
                            ...
                            {/* Nature Logo */}
                            <img className="dark:bg-transparent w-[40px] top-1 left-4 z-10 absolute text-base font-medium leading-none text-gray-800 py-3 bg-white" src="https://cdn-icons-png.flaticon.com/512/40/40107.png" alt="" />
                        ...
                        <div className="shadow-md duration-500 hover:scale-105 hover:shadow-xl relative group opacity-90 flex justify-center items-center h-full w-full">
                            ...
                            <img className="dark:bg-transparent w-[40px] top-1 left-4 z-10 absolute text-base font-medium leading-none text-gray-800 py-3 bg-white" src="https://cdn-icons-png.flaticon.com/512/1263/1263578.png" alt="" />
                            <div className="dark:text-white left-8 bottom-4 z-10 absolute leading-none text-gray-800 py-3 w-36">
                        ...
                        <div className="shadow-md duration-500 hover:scale-105 hover:shadow-xl relative group opacity-90 flex justify-center items-center h-full w-full">
                            ...
                            <img className="dark:bg-transparent w-[40px] top-1 left-4 z-10 absolute text-base font-medium leading-none text-gray-800 py-3 bg-white" src="https://cdn-icons-png.flaticon.com/512/3169/3169549.png" alt="" />
                            <div className="dark:text-white left-8 bottom-4 z-10 absolute leading-none text-gray-800 py-3 w-36">
                        ...
                        <div className="shadow-md duration-500 hover:scale-105 hover:shadow-xl relative group opacity-90 flex justify-center items-center h-full w-full">
                            ...
                            <img className="dark:bg-transparent w-[40px] top-1 left-4 z-10 absolute text-base font-medium leading-none text-gray-800 py-3 bg-white" src="https://cdn-icons-png.flaticon.com/512/701/701336.png" alt="" />
                            <div className="dark:text-white left-8 bottom-4 z-10 absolute leading-none text-gray-800 py-3 w-36">
                        ...
                        <div className="shadow-md duration-500 hover:scale-105 hover:shadow-xl relative group opacity-90 flex justify-center items-center h-full w-full">
                            ...
                            <img className="dark:bg-transparent w-[40px] top-1 left-4 z-10 absolute text-base font-medium leading-none py-3" src="https://cdn-icons-png.flaticon.com/512/5167/5167244.png" alt="" />
                            <div className="dark:text-white left-8 bottom-4 z-10 absolute leading-none text-gray-800 py-3 w-36">
                        ...
                        <div className="shadow-md duration-500 hover:scale-105 hover:shadow-xl relative group opacity-90 flex justify-center items-center h-full w-full">
                            ...
                            <img className="dark:bg-transparent w-[40px] top-1 left-4 z-10 absolute text-base font-medium rounded-[50%] leading-none py-3" src="https://cdn-icons-png.flaticon.com/512/2912/2912038.png" alt="" />
                            <div className="dark:text-white left-8 bottom-4 z-10 absolute leading-none text-gray-800 py-3 w-36">
